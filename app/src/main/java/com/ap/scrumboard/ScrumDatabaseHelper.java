...
public class ScrumDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateMyDatabase(SQLiteDatabase db,int oldVersion, int newVersion) {
        ...
        if(oldVersion < 20){
            ...
            insertSub(db,"Sub task 3","Main task 1","Doing","Employee3");
            insertSub(db,"Sub task 4","Main task 1","Doing","Employee4");
            insertSub(db,"Sub task 5","Main task 1","Doing","Employee5");
            insertSub(db,"Sub task 6","Main task 1","Done","Employee1");
            insertSub(db,"Sub task 7","Main task 1","Done","Employee2");
            insertSub(db,"Sub task 8","Main task 1","To Do","Employee1");
            insertSub(db,"Sub task 9","Main task 1","To Do","Employee2");
            insertSub(db,"Sub task 10","Main task 1","Doing","Employee3");
            insertSub(db,"Sub task 11","Main task 1","Doing","Employee4");
            insertSub(db,"Sub task 12","Main task 1","Doing","Employee5");
            ...
            insertSub(db,"Sub task 16","Main task 1","To Do","Employee2");
            ...
            insertSub(db,"Sub task 20","Main task 1","Done","Employee1");
            insertSub(db,"Sub task 21","Main task 2","To Do","Employee1");
            insertSub(db,"Sub task 22","Main task 2","To Do","Employee2");
            insertSub(db,"Sub task 23","Main task 2","Doing","Employee3");
            insertSub(db,"Sub task 24","Main task 2","Doing","Employee4");
            ...
            insertSub(db,"Sub task 31","Main task 2","Doing","Employee4");
            ...
            insertSub(db,"Sub task 39","Main task 2","Doing","Employee5");
            ...
            insertSub(db,"Sub task 45","Main task 3","Doing","Employee5");
            ...
            insertSub(db,"Sub task 52","Main task 3","Doing","Employee5");
            ...
            insertSub(db,"Sub task 58","Main task 3","Doing","Employee4");
            insertSub(db,"Sub task 59","Main task 3","Doing","Employee5");
            insertSub(db,"Sub task 60","Main task 3","Done","Employee1");
            insertSub(db,"Sub task 61","Main task 4","To Do","Employee1");
            insertSub(db,"Sub task 62","Main task 4","To Do","Employee2");
            insertSub(db,"Sub task 63","Main task 4","Doing","Employee3");
            insertSub(db,"Sub task 64","Main task 4","Doing","Employee4");
            insertSub(db,"Sub task 65","Main task 4","Doing","Employee5");
            insertSub(db,"Sub task 66","Main task 4","Done","Employee1");
            insertSub(db,"Sub task 67","Main task 4","Done","Employee2");
            insertSub(db,"Sub task 68","Main task 4","To Do","Employee1");
            insertSub(db,"Sub task 69","Main task 4","To Do","Employee2");
            insertSub(db,"Sub task 70","Main task 4","Doing","Employee3");
